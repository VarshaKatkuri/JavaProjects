...
public class TriangleFromSimpleGeometricObject  extends GeometricObject {
	 ...
	 * @throws InvalidTriangleSideException */
	  public void setSide1(double side1) throws InvalidTriangleSideException{
	    if(side1<0) 
	    	//throw new IllegalArgumentException("Side cannot be negative");
	    	throw new InvalidTriangleSideException(side1);
	    this.side1 = side1;
	  }
	  /** Set a new side2 
	 * @throws InvalidTriangleSideException */
	  public void setSide2(double side2)  throws InvalidTriangleSideException{
	    if(side2<0) 
	    	//throw new IllegalArgumentException("Side cannot be negative");
	    	throw new InvalidTriangleSideException(side2);
	    this.side2 = side2;
	    
	  }
	  /** Set a new side3 */
	  public void setSide3(double side3) throws InvalidTriangleSideException{
	    if(side3<0) 
	    	//throw new IllegalArgumentException("Side cannot be negative");
	    	throw new InvalidTriangleSideException(side3);
	    this.side3 = side3;
	  }
	  /** Return side1 */
